...
class Student(models.Model):
    ...
    behavior_rating = models.FloatField(
        default=5.0,
...
class Attendance(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['circle', 'date']),
        ]
...
class MemorizationRecord(models.Model):
    ...
    from_verse = models.IntegerField(null=True, blank=True, validators=[MinValueValidator(1)])
    to_verse = models.IntegerField(null=True, blank=True, validators=[MinValueValidator(1)])
    lesson_name = models.CharField(max_length=200, null=True, blank=True)
    page_number = models.IntegerField(null=True, blank=True, validators=[MinValueValidator(1), MaxValueValidator(604)])
...
class JuzTest(models.Model):
    ...
    juz_number = models.IntegerField(validators=[MinValueValidator(1), MaxValueValidator(30)], verbose_name="رقم الجزء")
    score = models.FloatField(validators=[MinValueValidator(0.0), MaxValueValidator(100.0)], verbose_name="الدرجة")
    grade = models.CharField(max_length=20, choices=GRADE_CHOICES)
